...
const AIChatAssistant = () => {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      ...
      const welcomeMessages = [
        `Hey ${user?.name || 'there'} 👋 Welcome back to Seekon Apparel! I'm Seekon, your intelligent shopping companion. I can help with shopping, orders, account management, and style advice. What can I assist you with today?`,
        `Hi ${user?.name || 'there'}! I'm Seekon, your personal shopping assistant. I can help you navigate our site, find products, and provide personalized recommendations. How can I help?`,
        `Welcome back, ${user?.name || 'friend'}! I'm Seekon and I know everything about our latest drops. I'm here to make your shopping experience amazing! What interests you today?`
      ];
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const BASE_URL = import.meta.env.VITE_API_URL || 'https://seekonbackend-production-5aa7.up.railway.app';
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-3 left-3 sm:bottom-4 sm:left-4 md:bottom-5 md:left-5 w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-white/40 backdrop-blur-xl border border-white/50 hover:bg-white/50 hover:border-white/60 text-white rounded-full shadow-2xl flex items-center justify-center z-40 transition-all duration-300"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-4 sm:inset-auto sm:bottom-6 sm:left-6 sm:w-[420px] sm:h-[600px] h-[calc(100vh-2rem)] bg-seekon-midnight/95 backdrop-blur-xl rounded-2xl sm:rounded-2xl shadow-2xl border border-white/20 z-[9999] flex flex-col overflow-hidden"
            >
