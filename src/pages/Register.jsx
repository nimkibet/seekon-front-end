...
const Register = () => {
  ...
  const handleSendVerificationCode = async () => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL || 'https://seekonbackend-production-da47.up.railway.app'}/api/auth/send-code`, {
        email
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${import.meta.env.VITE_API_URL || 'https://seekonbackend-production-da47.up.railway.app'}/api/auth/register`, {
