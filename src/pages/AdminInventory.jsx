          ...
          <table className="w-full min-w-[800px]">
            ...
            <tbody>
              {filteredInventory.map((item, index) => (
                ...
                >
                  <td className="py-4 px-4 text-white font-medium whitespace-nowrap">{item.name}</td>
                  <td className="py-4 px-4 text-gray-300 whitespace-nowrap">{item.category}</td>
                  <td className="py-4 px-4 text-gray-300 whitespace-nowrap">{item.brand}</td>
                  <td className="py-4 px-4 text-gray-300 whitespace-nowrap">{item.size}</td>
                  <td className="py-4 px-4 text-gray-300 whitespace-nowrap">{item.color}</td>
                  <td className="py-4 px-4 text-white whitespace-nowrap">{item.stock}</td>
