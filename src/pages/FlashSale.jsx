...
const FlashSale = () => {
  ...
  const SETTINGS_URL = 'https://seekonbackend-production.up.railway.app/api/settings/flash-sale';
  const ALL_PRODUCTS_URL = 'https://seekonbackend-production.up.railway.app/api/products';
