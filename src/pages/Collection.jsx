...
const Collection = () => {
  ...
  const getFilteredProducts = () => {
    ...
    // Filter out flash sale products from regular grid (unless viewing flash sale category)
    // This prevents duplication - flash sale items only appear in Flash Sale section
    const isFlashSaleCategory = category?.toLowerCase() === 'flashsale';
    if (!isFlashSaleCategory) {
