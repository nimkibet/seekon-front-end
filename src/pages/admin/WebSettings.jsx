...
const WebSettings = () => {
  ...
  const API_URL = 'https://seekonbackend-production.up.railway.app/api/settings/home';
  const EXCHANGE_RATE_API = 'https://seekonbackend-production.up.railway.app/api/settings/exchange-rate';
  ...
  const fetchExchangeRate = async () => {
    try {
      ...
      setExchangeRate(res.data.rate || 130);
    } catch (error) {
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-6">
        <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
          <FiDollarSign size={20} /> Currency Settings
        </h2>
          ...
          <div className="flex-1 w-full">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={saving}
                className="px-4 py-2 bg-[#00A676] text-white rounded-lg hover:bg-[#008F5D] transition-colors disabled:opacity-50 flex items-center gap-2"
              >
                <FiSave size={18} />
            ...
            <p className="text-sm text-gray-500 mt-2">
              Current rate: 1 USD = {exchangeRate || '130'} KES
            </p>
          </div>
        </div>
      </div>
