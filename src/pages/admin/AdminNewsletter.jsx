  ...
  const fetchSubscribers = async () => {
    try {
      ...
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL || 'https://seekonbackend-production.up.railway.app'}/api/admin/subscribers`,
        {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_API_URL || 'https://seekonbackend-production.up.railway.app'}/api/admin/newsletter/broadcast`,
        {
