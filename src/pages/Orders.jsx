                ...
                <div className="mt-6 lg:mt-0 lg:ml-6 flex flex-col sm:flex-row lg:flex-col space-y-2 sm:space-y-0 sm:space-x-2 lg:space-x-0 lg:space-y-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center space-x-2 px-4 py-2 sm:px-3 sm:py-2 text-sm font-medium text-white bg-[#00A676] hover:bg-[#008A5E] rounded-lg transition-colors duration-200 w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
                    >
